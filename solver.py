...
def remove_stiffness(sys_loop_map, state_vectors, loop_stiff_info, branches_in_kcl_nodes, kcl_branch_map, branch_params, branch_tags_in_loops):
    ...
    no_of_loops = len(sys_loop_map[0]) - len(branches_in_kcl_nodes) + 1
